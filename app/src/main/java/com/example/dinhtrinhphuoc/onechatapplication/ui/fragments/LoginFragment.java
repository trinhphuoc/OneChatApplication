...
import com.example.dinhtrinhphuoc.onechatapplication.core.login.LoginContract;
import com.example.dinhtrinhphuoc.onechatapplication.core.login.LoginPresenter;
import com.example.dinhtrinhphuoc.onechatapplication.ui.activities.RegisterActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    private void setDummyCredentials() {
        mETxtEmail.setText("Examples@gmail.com");
