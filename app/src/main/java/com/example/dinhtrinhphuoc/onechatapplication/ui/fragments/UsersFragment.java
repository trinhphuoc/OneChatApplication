...
import com.example.dinhtrinhphuoc.onechatapplication.core.users.add.get.GetUsersContract;
import com.example.dinhtrinhphuoc.onechatapplication.core.users.add.get.GetUsersPresenter;
import com.example.dinhtrinhphuoc.onechatapplication.models.User;
import com.example.dinhtrinhphuoc.onechatapplication.ui.activities.ChatActivity;
import com.example.dinhtrinhphuoc.onechatapplication.ui.adapters.UserListingRecyclerAdapter;
import com.example.dinhtrinhphuoc.onechatapplication.utils.ItemClickSupport;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View fragmentView = inflater.inflate(R.layout.users_fragment, container, false);
